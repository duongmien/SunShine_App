...
public class TinyDB {
    ...
    public ArrayList<SanPhamDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<SanPhamDomain> playerList =  new ArrayList<SanPhamDomain>();

        for(String jObjString : objStrings){
            SanPhamDomain player  = gson.fromJson(jObjString,  SanPhamDomain.class);
    ...
    public void putListObject(String key, ArrayList<SanPhamDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(SanPhamDomain player: playerList){
